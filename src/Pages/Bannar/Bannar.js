    ...
    <div class="hero min-h-screen mt-5 " id="home">
       ...
       <div>
        <div >
          <div >
         <Fade left>
            <h3 className="text-3xl mb-5">WELCOME TO MY WORLD</h3>
            <h1 className=" mt-5">
            ...
            <p>
              ...
              <a href="https://drive.google.com/file/d/12GbCFyNFYyPX5gumKYvntHuiRGCbnz0Y/view?usp=sharing"target='_blank' >
                <button className="btn_shadow mt-8">DOWENLODE RESUME</button> </a>
          </Fade> 
            ...
            <div className="hero_btn d_flex">
              <div className="col_1">
                ...
                <div className="button">
                 ...
                 <a href="https://www.linkedin.com/in/devsuzit/"target="_blank">
                <button className="btn_shadow">
              ...
              <div className="col_1">
                ...
                <a href=" https://www.figma.com/files/recent?fuid=1063111964740199590"target="_blank">
                <button className="btn_shadow">
                  <img src={Skil3} alt="" />
                  </button>
                </a>
        ...
        <img 
          src={hero}
          class="max-w-sm rounded-lg shadow-2xl radious"
        />
      </Fade>
      </div>
    </div>
